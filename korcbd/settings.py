"""
Django settings for korcbd project.
...
SECRET_KEY = 'of!v_90h#wq8p(rpbke_9-a+#e^!=v1(6hmz@@rqnlpfse81%w'
...
ROOT_URLCONF = 'korcbd.urls'

CRISPY_TEMPLE_PACK = 'bootstrap4'
...
WSGI_APPLICATION = 'korcbd.wsgi.application'
